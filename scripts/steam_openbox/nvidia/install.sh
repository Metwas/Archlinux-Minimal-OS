#!/bin/bash
echo "Initializing minimal Steam (Nvidia) ArchLinux install..."
set -e
...
sudo pacman -S --needed --noconfirm xorg-server xorg-xinit xorg-xrandr steam openbox xterm unclutter
##################################
